      ...
      <section className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            {/* Tabs */}
            <div className="animate-element animate-delay-300 flex gap-2 border-b border-border">
              <button
              ...
              <form className="space-y-5" onSubmit={onSignIn}>
                ...
                <div className="animate-element animate-delay-600 flex items-center justify-between text-sm">
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    <span className="text-foreground/90">Recordarme</span>
                  </label>
                  <a href="#" onClick={(e) => { e.preventDefault(); onResetPassword?.(); }} className="hover:underline text-violet-400 transition-colors">¿Olvidaste tu contraseña?</a>
                </div>
            ...
            {activeTab === 'register' && (
              <form className="space-y-5" onSubmit={onRegister}>
                <div className="animate-element animate-delay-400">
                  ...
                  <GlassInputWrapper>
                    <input name="fullName" type="text" placeholder="Juan Pérez" className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none" required />
                  </GlassInputWrapper>
                </div>
                ...
                <div className="animate-element animate-delay-600">
                  <label className="text-sm font-medium text-muted-foreground">Teléfono <span className="text-muted-foreground/50">(opcional)</span></label>
                  <GlassInputWrapper>
                    <input name="phone" type="tel" placeholder="+503 2395 1242" className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none" />
                  </GlassInputWrapper>
                </div>
                ...
                <div className="animate-element animate-delay-700">
                  ...
                  <GlassInputWrapper>
                    <div className="relative">
                      <input name="password" type={showPassword ? 'text' : 'password'} placeholder="••••••••" minLength={6} className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none" required />
                      <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute inset-y-0 right-3 flex items-center">
                        {showPassword ? <EyeOff className="w-5 h-5 text-muted-foreground hover:text-foreground transition-colors" /> : <Eye className="w-5 h-5 text-muted-foreground hover:text-foreground transition-colors" />}
                      </button>
                    </div>
